...
$kode    = $_GET['kode'];
$sql    = mysqli_query($conn, "SELECT * FROM data_pengguna where id_pengguna='$kode'");
            ...
            <div class="navbar-inner" style="border:1px solid #bbb; border-radius:10px; padding:10px 20px 10px 20px; margin-top:50px; margin-left:auto; margin-right:auto;">
                ...
                <div style="margin-top:10px;">
                    <form class="form-horizontal" name="form1" method="post" action="" enctype="multipart/form-data">
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input name="nama_lengkap" type="text" id="nama" class="input-xxlarge" value='<?php echo "$data[nama_lengkap]"; ?>'>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input name="email" type="text" id="jk" class="input-xxlarge" value='<?php echo "$data[email]"; ?>'>
                            </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                            <label class="control-label" for="nama">PIN</label>
                            <div class="controls">
                                <input name="pin" type="text" id="email" class="input-xxlarge" value='<?php echo "$data[pin]"; ?>'>
                            </div>
                        </div>
                        <div class="control-group">
                ...
                if (isset($_POST['update'])) {
                    mysqli_query($conn, "update data_pengguna set
                                            ...
                                            pin= '$_POST[pin]',
											alamat= '$_POST[alamat]'
											where id_pengguna='$kode'") or die('mysqli_error');
